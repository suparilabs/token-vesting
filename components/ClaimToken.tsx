...
const ClaimToken = props => {
    ...
    const vestingCount = props.vestingScheduleIndex + 1;
    ...
    const claimingDate = vestingSchedule != undefined ? moment.unix(vestingSchedule[2]).toLocaleString() : "-";
  ...
  return (
    <div>
        <hr></hr>
        <h5 className="mb-0">Vesting Schedule: {vestingCount} </h5>
        <hr></hr>
        <div className="d-flex justify-content-between">
                ...
                <div className="mt-5">
                  ...
                  <span className="text2">Claiming date：{claimingDate}</span>
