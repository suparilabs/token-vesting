  ...
  return (
    <div className="">
      ...
      <div className="rounded  box-border w-64 border-1 border-slate-300 text-left mb-2">
        ...
        <div><span className="font-medium ml-2">Price:</span> {props.price}</div>
        <div><span className="font-medium ml-2">Tokens:</span> {props.tokens}</div>
      </div>
    </div>
  );
}
    ...
    <div>
      ...
      <div className="text-center pt-6">
        ...
        <div className="col-span-1 ml-28">
          <div className="font-sans text-4xl pt-6 pb-8 font-semibold text-blue-600 ml-52 text-left">Participate in one of the best chances, Just one round at the cheapest price!</div>
        </div>          
        <div className="col-span-1 mr-28">
          <div className="mt-10"><StageData date="Completed" round="Private Sale" price="$0.05" tokens="1,000,000" /></div>
