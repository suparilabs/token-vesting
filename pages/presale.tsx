...
const options: Highcharts.Options = {
  ...
  colors: [
    "#BFBFF3","#C0D0F2","#A1C6FA","#65ADFF","#2C8EF9","#0179F3","#0A03FF","#3522F8","#5651E9","#0A03FF","#A19FF3","#65ADFF"
   ],
  plotOptions: {
    pie: {
      innerSize: 210,
         ...
         {(!checked || !checkoutShow) && (
          <div>
            <Modal.Header closeButton>
              <Modal.Title id="contained-modal-title-vcenter"><h4>Purchase SERA Token</h4></Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <Form>
                <Form.Group controlId="form_one">
                  ...
                  />
                  <Button className="amtButton" onClick={() => handleBuyTokenUsingBusd(busdAmount)} disabled={mining || !props.enoughBusd}>
                    Buy Tokens with BUSD
                  </Button>
                  <span className="buylink">Available Balance: {props && props.busdBalance && props.busdBalance.toFixed(2)} BUSD</span>
                </Form.Group>
                <Form.Group controlId="form_two">
                  ...
                  />
                  <Button className="amtButton" onClick={() => handleBuyTokensUsingUsdt(usdtAmount)} disabled={mining || !props.enoughUsdt}>
                    Buy Tokens with USDT
                  </Button>
                  <span className="buylink">Available Balance: {props && props.usdtBalance && props.usdtBalance.toFixed(2)} USDT</span>
                </Form.Group>
              </Form>
            </Modal.Body>
            <Modal.Footer>
...
<input id="terms" type="checkbox" name="terms" value="on" onChange={e => setChecked(!!e.target.checked)} />
<a href="presale.pdf" className="buylink" target="_blank"> I Agree to Sera Terms And Conditions </a>
</div>
{/*  */}
...
<div className="wrap">
<button type="button" id="trem_check"  className="btn btn-light trem_check" onClick={e => handleClick(e)} disabled={!checked || !enoughEth || !(enoughBusd || enoughUsdt)}> Buy SERA Now </button>
{/* SHOW PRESALE MODAL */}
