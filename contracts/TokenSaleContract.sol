 ...
 */
contract PrivateTokenSaleContract is Ownable, ReentrancyGuard {
...
contract TokenSale is Ownable {
    ...
    PrivateTokenSaleContract public _PrivateTokenSaleContract;
    ...
    constructor(
        ...
        // initialization
        _PrivateTokenSaleContract = new PrivateTokenSaleContract(address(_tokenContract));
    }
    ...
    function withdrawBUSD() private onlyOwner {
        IERC20Token(BUSD).transfer(alice, IERC20Token(BUSD).balanceOf(address(this)));
    }

    function withdrawUSDT() private onlyOwner {
        IERC20Token(USDT).transfer(alice, IERC20Token(USDT).balanceOf(address(this)));
    }
